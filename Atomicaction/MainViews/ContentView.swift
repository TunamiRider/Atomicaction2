            ...
            VStack(spacing: 20) {
                ...
                fieldSection(label: "Description") {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        .padding(.bottom, 10)
                        .onAppear {
                            // Background tint for the selected segment pill
                            UISegmentedControl.appearance().selectedSegmentTintColor = UIColor { traitCollection in
                                traitCollection.userInterfaceStyle == .dark
                                    ? UIColor(red: 0.35, green: 0.18, blue: 0.45, alpha: 1.0) // Dark Mode Purple
                                    : UIColor(red: 0.29, green: 0.53, blue: 0.52, alpha: 1.0) // Light Mode Teal
                            }
                            
                            // Customizing text colors for selected vs unselected states
...
//                    SeaSaltTimer(title: $title, description: $description, minutes: $minutes, descriptionMode: $descriptionMode, steps: $steps, isTapped: $isTapped)
//                        .navigationBarBackButtonHidden(true) // 1. Hide system back
...
//                        .id("contentView")
                ...
                .animation(.easeInOut(duration: 10), value: isTapped)
