        ...
        ZStack {
            ...
            VStack(alignment: .center, spacing: 5) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    Label("Actions — Today, \(Date().formatted(.dateTime.month(.abbreviated).day()))", systemImage: "clock")
                    ...
                    Chart(hourlyBuckets, id: \.hour) { bucket in
                        BarMark(
                            x: .value("Hour", Double(bucket.hour)+1.0),
                    ...
                    .chartXAxis {
                        AxisMarks(values: [0, 3, 6, 9, 12, 15, 18, 21, 25]) { value in
                            AxisValueLabel {
