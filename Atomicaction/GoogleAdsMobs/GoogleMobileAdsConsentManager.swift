...
class GoogleMobileAdsConsentManager: NSObject {
  ...
  func gatherConsent(consentGatheringComplete: @escaping (Error?) -> Void) {
    ...
    // debugSettings.testDeviceIdentifiers = [ "e036b20abdf9d274903aab0c9b2aa19b" ]
...
/*
 https://github.com/googleads/googleads-mobile-ios-examples/blob/69a2f86c67544a03e58751cdab384a89566b51a7/Swift/advanced/SwiftUIDemo/
 */
