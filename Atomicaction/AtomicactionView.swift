...
//                print("Consent gathering error: \(consentError.localizedDescription)")
//            }
        ...
        .task{
            ...
            do {
                try modelContext.delete(model: DailyProgress.self, where: #Predicate{ $0.date < twoWeeksAgo })
                try modelContext.delete(model: DailyBreak.self, where: #Predicate{ $0.date < twoWeeksAgo })
